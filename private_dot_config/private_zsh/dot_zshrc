...
# The Oh My Zsh framework itself is not loaded.

# =========================================================
# Safety directories
# =========================================================
# Create dirs used by history, completion cache, plugins, and
# vendor source. Safe to run repeatedly.
...
# =========================================================
# The cd alias/function itself is defined in aliases.zsh.
if command -v zoxide >/dev/null 2>&1; then
  eval "$(zoxide init zsh)"
fi

# =========================================================
# Fuzzy finder shell integration (fzf's own scripts, not fzf.zsh)
# =========================================================
